/**
 ...
 #  Name                       | Email
    ---------------------------|----------------------------------
    Mohamed Khaled Gamal       | medo.kgm2018@gmail.com
    Mohamed Mahmoud Abdelbaset | mohamedmahmoud050505@gmail.com
    Mohamed Sherif Mohamed     | M07amedsherif2005@gmail.com
    --------------------------------------------------------------
**/
...
void Filter_Edge_Detector_10(bool is_auto = 0)
{
    ...
    for (int i = 0; i < My_image.width-thick; i++)
    {
        for (int j = 0; j < My_image.height-thick; j++)
        {
            ...
            {
                for (int jj =  j; jj <= min(j + thick - 1 , My_image.height); jj++)
                {
